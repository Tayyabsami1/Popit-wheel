...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en" class="dark">\n  <head>\n    <meta charset="utf-8">\n    <link rel="icon" href="' + assets2 + '/images/icons/pwa-64x64.png" sizes="48x48">\n    <link\n      rel="icon"\n      href="' + assets2 + '/images/icons/pwa-64x64.png"\n      sizes="any"\n      type="image/svg+xml"\n    >\n    <link\n      rel="apple-touch-icon"\n      href="' + assets2 + '/images/icons/apple-touch-icon-180x180.png"\n      sizes="180x180"\n    >\n    <meta\n      name="viewport"\n      content="initial-scale=1, minimum-scale=1, maximum-scale=5, width=device-width"\n    >\n    <link\n      rel="preload"\n      href="' + assets2 + `/Quicksand.ttf"
      as="font"
      type="font/ttf"
      crossorigin
    >
