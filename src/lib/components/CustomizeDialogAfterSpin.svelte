...
<label class="label">
  ...
  <select class="select" bind:value={afterSpinSound}>
...
<label class="flex items-center space-x-2 w-fit">
  <input type="checkbox" bind:checked={displayWinnerDialog} class="checkbox" />
...
<label class="label">
  ...
  <select class="select" bind:value={confetti}>
